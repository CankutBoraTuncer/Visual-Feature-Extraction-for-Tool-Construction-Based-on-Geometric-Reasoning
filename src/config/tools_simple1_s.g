...
cam_front_left(world): { rel: [0.65, 0.65, 1,   0.17987373,  -0.37692368,  -0.84218296,   0.34103055 ], shape: camera, size: [0.1], width: 240, height: 240, focalLength: 3, zRange: [0.5, 3] },
