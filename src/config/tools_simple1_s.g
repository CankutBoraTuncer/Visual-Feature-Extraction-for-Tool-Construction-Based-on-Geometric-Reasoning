...
at_prism_short_hollow(obj_prism_short_hollow) : {X: [0.1 0.1 0.09, 0.7 0 0 -0.7], shape: marker, size: [0.001]}

obj_sphere(ob_plane): {X: [0.15 -0.05 0.07 0.7 0 -0.7 0], joint:rigid, color: [0, 1, 1], contact: 1, shape: mesh, visual: True, mesh: <../models/simple/sphere.stl>}
at_sphere(obj_sphere) : {X: [0.15 -0.0 0.07, 1 0 0 0], shape: marker, size: [0.001]}
